    ...
    public partial class SM_600
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"User_Input",outputColumnName:@"User_Input")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.040108014F,L2Regularization=0.03125F,LabelColumnName=@"Classification",FeatureColumnName=@"Features"}), labelColumnName:@"Classification"))      
