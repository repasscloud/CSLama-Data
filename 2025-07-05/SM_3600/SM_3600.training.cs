    ...
    public partial class SM_3600
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"User_Input",outputColumnName:@"User_Input")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=1322,MinimumExampleCountPerLeaf=20,LearningRate=0.18682222726662517,LabelColumnName=@"Classification",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.41693960910709676,FeatureFraction=0.978390288503887,L1Regularization=2.989147941789654E-10,L2Regularization=0.9999997766729865},MaximumBinCountPerFeature=153}))      
